    ...
    while True:
        ...
        if args.optimizer == 'Adam_mini':
            for param_group in optimizer.param_groups:
                ...
                elif 'q_proj' in p_name or 'k_proj' in p_name:
                    param_group['lr'] = lrs[3]
                elif 'v_proj' in p_name or 'o_proj' in p_name:
                    param_group['lr'] = lrs[4]
                elif 'mlp' in p_name:
                    param_group['lr'] = lrs[5]
                else:
                    raise ValueError(f"Unknown parameter group: {p_name}")
